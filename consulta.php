            ...
            <div class="row">
                <div class="col">
                  <table class="table">
                    ...
                    <td scope="col">
                    <button type="button" class="btn btn-dark" onclick="location.href='editar.php?id=<?php echo $resultado[$i]['id'];?>'"style="width: 72px;" >Editar</button>
                    
                    <button type="button" class="btn btn-dark" onclick="location.href='excluir.php?id=<?php echo $resultado[$i]['id'];?>'"style="width: 72px;" >Excluir</button>
                        </td>
                    </tr>
                <?php        
                    }    
